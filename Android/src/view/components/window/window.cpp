...
void Window::PushStyle()
{
    ...
    ImGui::PushStyleColor(ImGuiCol_Tab, ImVec4(0.07f, 0.22f, 0.13f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_TabHovered, ImVec4(0.15f, 0.45f, 0.25f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_TabActive, ImVec4(0.12f, 0.36f, 0.20f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_TabUnfocused, ImVec4(0.05f, 0.14f, 0.09f, 1.0f));
    ImGui::PushStyleColor(ImGuiCol_TabUnfocusedActive, ImVec4(0.08f, 0.25f, 0.15f, 1.0f));
